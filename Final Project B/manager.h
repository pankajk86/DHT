...
// File name: 	manager.h
// Author: 		Pankaj Kumar (pankajk@usc.edu)
// Date: 		2013.8
// Description: CSCI551 fall 2013 project b, manager module header file.
